...
\includegraphics{../images/hist-mn-earn.png’}
...
<<echo=F, include = F, results=tex>>=
options(xtable.comment = F)
t2 = xtable(summary_stats_deg_type, caption = "Degree Type Summary Statistics")
